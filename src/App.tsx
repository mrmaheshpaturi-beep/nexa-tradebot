...
const OpsControlCenter = lazy(() => import('./pages/PhaseNineteenHardeningPages').then((module) => ({ default: module.PhaseNineteenOpsControlCenter })))
...
export default function App() {
  return <HashRouter><AuthProvider><Suspense fallback={<LoadingState />}><Routes>
    ...
    <Route path="notifications" element={<Notifications />} /><Route path="system-health" element={<SystemHealth />} /><Route path="system-operations" element={<SystemOperations />} /><Route path="ops-control-center" element={<OpsControlCenter />} /><Route path="validation-lab" element={<SystemOperations />} /><Route path="alert-center" element={<SystemOperations />} /><Route path="strategy-governance" element={<StrategyGovernance />} /><Route path="strategy-lab" element={<StrategyGovernance />} /><Route path="audit-logs" element={<AuditLogs />} />
