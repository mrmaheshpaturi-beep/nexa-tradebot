    ...
    public function status(): JsonResponse
    {
        ...
        return response()->json(['data' => [
            ...
            'broker_fleet' => [
                ...
                'dashboard_api' => '/api/v1/fleet/dashboard',
                'order_send_phase18' => 0,
                'phase_10_sole_execution' => true,
                'copy_trading' => false,
                'live_auto_exists' => false,
                'ai_may_route' => false,
            ...
            'production_hardening' => [
                'phase' => 19,
                'status' => 'READY',
                'hardening_version' => 'ProductionHardening/v1',
                'ops_control_center_api' => '/api/v1/hardening/ops',
                'order_send_phase19' => 0,
                'ai_execution' => 0,
                'live_auto_exists' => false,
                'unknown_execution_policy' => 'RECONCILE_NOT_RETRY',
                'phase_9_risk_mandatory' => true,
                'phase_10_sole_execution' => true,
